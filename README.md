...
🔗 **슬라이드 바로 보기 → https://amnotyoung.github.io/lunch-time-claude-camp/** (주차별 슬라이드를 브라우저에서 넘겨볼 수 있습니다)
...
[The Unlicense](LICENSE) — 퍼블릭 도메인. 출처 표기 없이 누구나 자유롭게 복사·수정·배포·상업적 이용할 수 있습니다. 아무 조건 없습니다.
